...
matrices = [
    {
        ...
        "subtypes": [
            ...
            },
            {
                ...
                "type": "local",
                "matrix": "enterprise-attack",
                "path": "enterprise/spacecraft",
                "platforms": ["Spacecraft"],
                "descr": "Below are the tactics and techniques representing the MITRE ATT&CK<sup>&reg;</sup> Spacecraft platform. The techniques below are known to target spacecraft systems.",
                "subtypes": [],
            },
        ],
    },
...
platform_to_path = {
    ...
    "Spacecraft": "enterprise/spacecraft",
